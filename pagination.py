...
# Create directory for pagination data
os.makedirs("pagination_data", exist_ok=True)
...
def save_pagination_data(unique_name: str, pagination_data):
    ...
    # Save to local file
    filepath = os.path.join("pagination_data", f"{unique_name}.json")
    with open(filepath, "w", encoding="utf-8") as f:
        json.dump(pagination_data, f, indent=2)
    
    print(f"Pagination data saved for {unique_name}")
